...
class TestQuake2(TestCase):
    ...
    def test_quake2_process_request_shutdown(self, MockProcessShutdown):
        ...
        assert Quake2.process_shutdown.called

    @patch('masters.Quake2.process_heartbeat')
    def test_quake2_process_request_heartbeat(self, MockProcessHeartbeat):
        ...
        assert Quake2.process_heartbeat.called
